    ...
    <aside class="w-72 bg-white shadow-xl p-6 flex flex-col justify-between">
        ...
        <ul class="space-y-3">
          ...
          <li>
            <a href="{{ url('/dashboard') }}"
              ...
              <i class="fa-solid fa-chart-line mr-3 {{ request()->is('dashboard') ? 'text-white' : 'text-[#842A3B]' }}"></i>
              Dashboard
            </a>
          </li>
          <!-- HOME -->
          ...
          <li>
            <a href="{{ route('formulir') }}"
              ...
              {{ request()->routeIs('formulir') 
                  ? 'bg-gradient-to-r from-[#842A3B] to-[#C95A6B] text-white shadow-md' 
                  : 'hover:bg-[#842A3B]/10 hover:text-[#842A3B] text-slate-600' }}">
              <i class="fa-solid fa-file-lines mr-3 {{ request()->routeIs('formulir') ? 'text-white' : 'text-[#842A3B]' }}"></i>
              Formulir
            </a>
          </li>        
          <!-- JATAH CUTI -->
          <li>
            <a href="{{ route('jatah-cuti') }}"
              ...
              {{ request()->routeIs('jatah-cuti') 
                  ? 'bg-gradient-to-r from-[#842A3B] to-[#C95A6B] text-white shadow-md' 
                  : 'hover:bg-[#842A3B]/10 hover:text-[#842A3B] text-slate-600' }}">
              <i class="fa-solid fa-calendar-days mr-3 {{ request()->routeIs('jatah-cuti') ? 'text-white' : 'text-[#842A3B]' }}"></i>
              Jatah Cuti
            </a>
          </li>
          <!-- RIWAYAT CUTI -->
          <li>
            <a href="{{ route('riwayat-cuti.index') }}"
              ...
              {{ request()->routeIs('riwayat-cuti.index') 
                  ? 'bg-gradient-to-r from-[#842A3B] to-[#C95A6B] text-white shadow-md' 
                  : 'hover:bg-[#842A3B]/10 hover:text-[#842A3B] text-slate-600' }}">
              <i class="fa-solid fa-clock-rotate-left mr-3 {{ request()->routeIs('riwayat-cuti.index') ? 'text-white' : 'text-[#842A3B]' }}"></i>
              Riwayat Cuti
            </a>
          </li>
          <!-- MASTER JENIS CUTI -->
          <li>
            <a href="{{ route('master.jeniscuti') }}"
              ...
              {{ request()->routeIs('master.jeniscuti') 
                  ? 'bg-gradient-to-r from-[#842A3B] to-[#C95A6B] text-white shadow-md' 
                  : 'hover:bg-[#842A3B]/10 hover:text-[#842A3B] text-slate-600' }}">
              <i class="fa-solid fa-clipboard-list mr-3 {{ request()->routeIs('master.jeniscuti') ? 'text-white' : 'text-[#842A3B]' }}"></i>
              Master Jenis Cuti
            </a>
          </li>
        </ul>
      ...
      <div class="mt-10">
        ...
        <a href="#"
          ...
          <i class="fa-solid fa-user mr-3 text-[#842A3B]"></i> Profile
        </a>
      </div>
    </aside>
